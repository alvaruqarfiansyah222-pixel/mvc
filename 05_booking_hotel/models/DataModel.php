...
class BookingHotelModel {
    private PDO $pdo;
    private string $table = 'hotel_bookings';
    ...
    public function create(array $d): void {
        $cols = "nama, tipe_kamar, malam, orang, harga_per_malam, total";
    ...
    public function update(int $id, array $d): void {
        $cols = explode(',', "nama, tipe_kamar, malam, orang, harga_per_malam, total");
